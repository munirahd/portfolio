...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _consts_websites__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../consts/websites */ \"./src/app/consts/websites.js\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  get(target, name) {\n    if (name === \"email\") return `${_consts_websites__WEBPACK_IMPORTED_MODULE_0__[\"default\"].email}${target.email}`;\n\n    if (name === \"phone\") return `tel:${target.phone}`;\n\n    if (name === \"linkedin\")\n      return `https://${_consts_websites__WEBPACK_IMPORTED_MODULE_0__[\"default\"].linkedin}${target.linkedin}`;\n\n    if (name === \"discord\")\n      return `https://${_consts_websites__WEBPACK_IMPORTED_MODULE_0__[\"default\"].discord}${target.discord.id}`;\n    if (name === \"discordTag\") return target.discord.tag;\n    return `${name === \"email\" ? \"\" : \"https://\"}${_consts_websites__WEBPACK_IMPORTED_MODULE_0__[\"default\"][name] ?? \"\"}${\n      target[name]\n    }`;\n  },\n});\n\n\n//# sourceURL=webpack://portfolio/./src/app/proxies/media.js?");
...
/******/ 			return "js/" + {"src_app_views_About_js":"6fce4b43ddff14d41a08","src_app_views_Contacts_js":"a7b9c5fb73d68e75d3a4","src_app_views_Home_js":"2b25e1cac949af5d5ac4","src_app_views_PageNotFound_js":"889f973003c86d2b46df","src_app_views_Projects_js":"bd0cfef135af6dd962b0"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
